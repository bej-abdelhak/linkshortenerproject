---
description: "Use when creating, modifying, or adding UI components. Enforces shadcn/ui for all components in components/ directory with no custom component exceptions."
